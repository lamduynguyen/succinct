...
struct darray64 {
  struct builder {
    ...
    void append1(size_t skip0 = 0) {
      ...
      if (n_ones % block_size == 0) { block_inventory.push_back(bits.size() - 1); }
  ...
  void map(Visitor &visit) {
    visit(m_num_ones, "m_num_ones")(m_bits, "m_bits")(m_block_inventory, "m_block_inventory")(m_subblock_inventory,
