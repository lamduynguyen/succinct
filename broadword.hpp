...
inline uint64_t zcompare_step_8(uint64_t x) { return ((x | ((x | msbs_step_8) - ones_step_8)) & msbs_step_8) >> 7; }
...
static const uint8_t debruijn64_mapping[64] = {63, 0,  58, 1,  59, 47, 53, 2,  60, 39, 48, 27, 54, 33, 42, 3,
